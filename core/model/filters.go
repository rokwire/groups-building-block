...
type GroupsFilter struct {
	...
	ResearchOpen     *bool                           `json:"research_open"`      // open or closed research groups
	ResearchGroup    *bool                           `json:"research_group"`     // indicator for a research or a normal group
	ResearchAnswers  *map[string]map[string][]string `json:"research_answers"`   // research group matching answers
