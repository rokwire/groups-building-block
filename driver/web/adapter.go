...
func NewWebAdapter(app *core.Application, host string, appKeys []string, internalApiKeys []string, oidcProvider string, oidcClientID string) *Adapter {
	auth := NewAuth(app, appKeys, internalApiKeys, oidcProvider, oidcClientID)
