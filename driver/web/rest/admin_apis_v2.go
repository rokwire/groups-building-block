...
func (h *AdminApisHandler) GetGroupsV2(OrgID string, current *model.User, w http.ResponseWriter, r *http.Request) {
	...
	_, groups, err := h.app.Admin.GetGroups(OrgID, current, groupsFilter)
	if err != nil {
...
func (h *AdminApisHandler) GetGroupsV3(OrgID string, current *model.User, w http.ResponseWriter, r *http.Request) {
	var groupsFilter model.GroupsFilter
...
func (h *AdminApisHandler) GetUserGroupsV2(OrgID string, current *model.User, w http.ResponseWriter, r *http.Request) {
	var groupsFilter model.GroupsFilter
...
func (h *AdminApisHandler) GetGroupV2(OrgID string, current *model.User, w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	id := params["id"]
	if len(id) <= 0 {
