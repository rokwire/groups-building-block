...
// BbsGetUserGroupMemberships gets the user groups memberships
// @Description Gives the user groups memberships
// @ID BBsGetUserGroupMemberships
// @Tags BBs
// @Accept json
// @Param identifier path string true "Identifier"
// @Success 200 {object} userGroupShortDetail
// @Security BBsAPIKeyAuth
// @Router /api/bbs/user/{identifier}/groups [get]
func (h *BBsAPIsHandler) BBsGetUserGroupMemberships(clientID string, w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
...
func (h *BBsAPIsHandler) BBsGetGroup(clientID string, w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	identifier := params["identifier"]
	if len(identifier) <= 0 {
		log.Println("Identifier is required")
...
// BBsGetGroupMembersByGroupTitle Retrieves group members by  title
// @Description Retrieves group members by  title
// @ID BBsGetGroupMembersByGroupTitle
// @Tags BBs
// @Accept json
...
func (h *BBsAPIsHandler) BBsGetGroupMembersByGroupTitle(clientID string, w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	title := params["title"]
...
// @Success 200
// @Security BBsAPIKeyAuth
// @Router /bbs/authman/synchronize [post]
func (h *BBsAPIsHandler) SynchronizeAuthman(clientID string, w http.ResponseWriter, r *http.Request) {
...
// @Security BBsAPIKeyAuth
// @Router /bbs/stats [get]
func (h *BBsAPIsHandler) GroupStats(clientID string, w http.ResponseWriter, r *http.Request) {
...
func (h *BBsAPIsHandler) UpdateGroupDateUpdated(clientID string, w http.ResponseWriter, r *http.Request) {
	//validate input
	params := mux.Vars(r)
...
func (h *BBsAPIsHandler) CreateGroupEvent(clientID string, w http.ResponseWriter, r *http.Request) {
	//validate input
	params := mux.Vars(r)
	groupID := params["group-id"]
	if len(groupID) <= 0 {
...
func (h *BBsAPIsHandler) DeleteGroupEvent(clientID string, w http.ResponseWriter, r *http.Request) {
	//validate input
	params := mux.Vars(r)
	groupID := params["group-id"]
	if len(groupID) <= 0 {
...
func (h *BBsAPIsHandler) SendGroupNotification(clientID string, w http.ResponseWriter, r *http.Request) {
	//validate input
	params := mux.Vars(r)
	groupID := params["group-id"]
	if len(groupID) <= 0 {
